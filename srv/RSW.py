...
def RSW_chup(ip_addr='192.168.0.1', ch=''):
    """
    Записать/прочитать рабочий канал ВВЕРХ 
...
def RSW_chdn(ip_addr='192.168.0.1', ch=''):
    """
    Записать/прочитать рабочий канал ВНИЗ
    @param ip - ip-адрес устройства
    @param ch - Номер канала 1 - канал А, 0 - канал Б
    """
    if ch:
...
def RSW_status(ip_addr='192.168.0.1'):
    """
    Получить слово состояния переключателя резерва
    @param ip - ip-адрес устройства
...
def RSW_3v(ip_addr='192.168.0.1'):
    """
    Получить напряжение питания коммутатора ВЧ-ВВЕРХ (+3,0 В)
    @param ip - ip-адрес устройства
    @return 0.00..4.07 В
    """
...
def RSW_2_5v1(ip_addr='192.168.0.1'):
    """
    Получить напряжение питания коммутатора ПЧ-ВВЕРХ и коммутатора ТЕСТ (+2,5 В)
    @param ip - ip-адрес устройства
    @return 0.00..3.02 В
    """
...
def RSW_2_5v2(ip_addr='192.168.0.1'):
    """
    Получить напряжение питания коммутатора ПЧ-ВНИЗ и коммутатора ВЧ-ВНИЗ (+2,5 В)
    @param ip - ip-адрес устройства
    @return 0.00..3.02 В
    """
...
def RSW_11v(ip_addr='192.168.0.1'):
    """
    Получить напряжение питания коммутатора БАС (+11 В)
    @param ip - ip-адрес устройства
    @return 0.00..14.1 В
    """
